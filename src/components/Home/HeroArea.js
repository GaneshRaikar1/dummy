...
const HeroArea = () => {
   return (
      <>
         <section className="hero__area hero__height-1 pb-200 pt-200 d-flex align-items-center" style={{ backgroundImage: `url('http://www.swakruta.in/static/115a639edee9b04b4504282d4579a8ff/0979f/swak-collage3.jpg')`, backgroundSize: 'cover' }}>
